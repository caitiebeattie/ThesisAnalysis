...
//========================================
//========================================
void EvaluateSys_ratlo(bool epup = false, int debug = 0)
{
  //=================================================================
  //============= List Files for Different Systematics ==============
  //=================================================================
      // nominal file
      std::string file_nom       = "UnfoldingData_2D_non_R04_qV0C_epV0A_3050_lo30_30_Nov14.root";
      std::string file_plus5     = "UnfoldingData_2D_non_R04_qV0C_epV0A_3050_lo30_hipT_30_Nov14.root";
      std::string file_min5      = "UnfoldingData_2D_non_R04_qV0C_epV0A_3050_lo30_lopT_30_Nov14.root";
      std::string file_eff       = "UnfoldingData_2D_non_R04_qV0C_epV0A_3050_lo30_trak_30_Nov14.root";
      std::string file_reweight  = "UnfoldingData_2D_non_R04_qV0C_epV0A_3050_lo30_rewe_30_Nov14.root";
  ...
  //================================================================
      ...
      if (sigma == false){
        if (epup == false) name << "preSystematics_R0" << R << "0_3050_" << (R/2)+1 << "0_loinout_Nov14.root";
        if (epup == true)  name << "preSystematics_R0" << R << "0_3050_" << (R/2)+1 << "0_loinoutup_Nov14.root";}
      if (sigma == true){
        if (epup == false) name << "preSystematics_R0" << R << "0_sigma_3050_" << (R/2)+1 << "0_loinout_Nov14.root";
        if (epup == true)  name << "preSystematics_R0" << R << "0_sigma_3050_" << (R/2)+1 << "0_loinoutup_Nov14.root";}
