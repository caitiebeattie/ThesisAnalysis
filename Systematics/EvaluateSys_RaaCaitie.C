...
//========================================
//========================================
void EvaluateSys_RaaCaitie(int debug = 0)
{
  //=================================================================
  //============= List Files for Different Systematics ==============
  //=================================================================
      // nominal file
      std::string file_nom       = "UnfoldingData_2D_non_R02_3050_lo30_Jan28.root";
      std::string file_plus5     = "UnfoldingData_2D_non_R02_3050_lo30_hipT_Jan28.root";
      std::string file_min5      = "UnfoldingData_2D_non_R02_3050_lo30_hipT_Jan28.root";
      //std::string file_eff       = "UnfoldingData_AreaBased_non_R04_010_trak_Sep27.root";
      //std::string file_quarks    = "../Raa/ChargedRaa/Unfolding_ML_HannahMethod_R040_QuarkOnlyResponse.root";
      //std::string file_gluons    = "../Raa/ChargedRaa/Unfolding_ML_HannahMethod_R040_GluonOnlyResponse.root";
      //std::string file_reweight  = "UnfoldingData_AreaBased_non_R04_010_rewe_Sep27.root";
  ...
  //===============================================================
      ...
      //fnom->ls();
      TH1D* h1_nom = (TH1D*)fnom->Get(histname.c_str());
 ...
 /*     TFile* feff = new TFile(file_eff.c_str());
      TH1D* h1_eff = (TH1D*)feff->Get(histname.c_str());
  ...
  */
      ...
      TH1D* h1_plus5 = (TH1D*)fplus5->Get(histname.c_str());
      ...
      TH1D* h1_min5 = (TH1D*)fmin5->Get(histname.c_str());
    ...
    /*  TFile* frw = new TFile(file_reweight.c_str());
      TH1D* h1_rw = (TH1D*)frw->Get(histname.c_str());
      h1_rw->SetName("h1_rw");
  ...
  */
  ...
  //================================================================
      ...
      name << "preSystematics_R020_3050_Jan28.root";
