...
//========================================
//========================================
void EvaluateSys_ese(int debug = 0)
{
  //=================================================================
  //============= List Files for Different Systematics ==============
  //=================================================================
      //nominal file low
      std::string lo_nom       = "UnfoldingData_2D_non_R02_3050_lo30_Feb4.root";
      std::string lo_plus5     = "UnfoldingData_2D_non_R02_3050_lo30_hipT_Feb4.root";
      std::string lo_min5      = "UnfoldingData_2D_non_R02_3050_lo30_lopT_Feb4.root";
      std::string lo_eff       = "UnfoldingData_2D_non_R02_3050_lo30_trak_Feb4.root";
      std::string lo_reweight  = "UnfoldingData_2D_non_R02_3050_lo30_rewe_Feb1.root";
      //nominal file high
      std::string hi_nom       = "UnfoldingData_2D_non_R02_3050_hi30_Feb4.root";
      std::string hi_plus5     = "UnfoldingData_2D_non_R02_3050_hi30_hipT_Feb4.root";
      std::string hi_min5      = "UnfoldingData_2D_non_R02_3050_hi30_lopT_Feb4.root";
      std::string hi_eff       = "UnfoldingData_2D_non_R02_3050_hi30_trak_Feb4.root";
      std::string hi_reweight  = "UnfoldingData_2D_non_R02_3050_hi30_rewe_Feb1.root";
  ...
  //=================================================================
     ...
     stringstream ss;
     const char* delim = "_";
     for (int i = 0; i < lo_nom.length(); i++)    {
         const char *a = &lo_nom[i];
         letters.push_back(a);
  ...
  //===============================================================
      ...
      TFile* fnomh = new TFile(hi_nom.c_str());
      TFile* fnoml = new TFile(lo_nom.c_str()); 
      //fnom->ls();
      //retrieve 2D hist
      TH2D* h2_nomh = (TH2D*)fnomh->Get(histname.c_str());
      TH2D* h2_noml = (TH2D*)fnoml->Get(histname.c_str()); 
      //project high
      TH1D* h1_nomi = (TH1D*)h2_nomh->ProjectionX("h1_nomi");
      //project low
      TH1D* h1_nomo = (TH1D*)h2_noml->ProjectionX("h1_nomo");
      //Divide hists to get nominal
      TH1D* h1_nom = (TH1D*)h1_nomo->Clone("h1_nom");
      h1_nom->Divide(h1_nomi);
      //Get Kinematic efficiencies
      TH1D* hKinNum_nom = (TH1D*)fnomh->Get(histnameKinNum.c_str());
      hKinNum_nom->SetName("hKinNum_nom");
      TH1D* hKinDenom_nom = (TH1D*)fnomh->Get(histnameKinDenom.c_str());
      ...
      // +1 Iterations
      TH2D* h2_iterhighh = (TH2D*)fnomh->Get(histnameplus1.c_str());
      TH2D* h2_iterhighl = (TH2D*)fnoml->Get(histnameplus1.c_str());
      //project in-plane
      TH1D* h1_iterhighi = (TH1D*)h2_iterhighh->ProjectionX("h1_iterhighi");
      //project out-of-plane
      TH1D* h1_iterhigho = (TH1D*)h2_iterhighl->ProjectionX("h1_iterhigho");
      //Divide hists to get nominal
      ...
      // -1 Iterations
      TH2D* h2_iterlowh = (TH2D*)fnomh->Get(histnamemin1.c_str());
      TH2D* h2_iterlowl = (TH2D*)fnoml->Get(histnamemin1.c_str());
      TH1D* h1_iterlowi = (TH1D*)h2_iterlowh->ProjectionX("h1_iterlowi");
      TH1D* h1_iterlowo = (TH1D*)h2_iterlowl->ProjectionX("h1_iterlowo");
      ...
      TFile* feffh = new TFile(hi_eff.c_str());
      TFile* feffl = new TFile(lo_eff.c_str());
      TH2D* h2_effh = (TH2D*)feffh->Get(histname.c_str());
      TH2D* h2_effl = (TH2D*)feffl->Get(histname.c_str());
      //project in-plane
      TH1D* h1_effi = (TH1D*)h2_effh->ProjectionX("h1_effi");
      //project out-of-plane
      TH1D* h1_effo = (TH1D*)h2_effl->ProjectionX("h1_effo");
      TH1D* h1_eff = (TH1D*)h1_effo->Clone("h1_eff");
      h1_eff->Divide(h1_effi);
      TH1D* hKinNum_eff = (TH1D*)feffh->Get(histnameKinNum.c_str());
      hKinNum_eff->SetName("hKinNum_eff");
      TH1D* hKinDenom_eff = (TH1D*)feffh->Get(histnameKinDenom.c_str());
      ...
      //+5 GeV/c
      TFile* fplus5h = new TFile(hi_plus5.c_str());
      TFile* fplus5l = new TFile(lo_plus5.c_str());
      TH2D* h2_plus5h = (TH2D*)fplus5h->Get(histname.c_str());
      TH2D* h2_plus5l = (TH2D*)fplus5l->Get(histname.c_str());
      //project in-plane
      TH1D* h1_plus5i = (TH1D*)h2_plus5h->ProjectionX("h1_plus5i");
      //project out-of-plane
      TH1D* h1_plus5o = (TH1D*)h2_plus5l->ProjectionX("h1_plus5o");
      //Divide hists to get nominal
      TH1D* h1_plus5 = (TH1D*)h1_plus5o->Clone("h1_plus5");
      h1_plus5->Divide(h1_plus5i);
      TH1D* hKinNum_plus5 = (TH1D*)fplus5h->Get(histnameKinNum.c_str());
      hKinNum_plus5->SetName("hKinNum_plus5");
      TH1D* hKinDenom_plus5 = (TH1D*)fplus5h->Get(histnameKinDenom.c_str());
      ...
      //-5 GeV/c
      TFile* fmin5h = new TFile(hi_min5.c_str());
      TFile* fmin5l = new TFile(lo_min5.c_str());
      TH2D* h2_min5h = (TH2D*)fmin5h->Get(histname.c_str());
      TH2D* h2_min5l = (TH2D*)fmin5l->Get(histname.c_str());
      //project in-plane
      TH1D* h1_min5i = (TH1D*)h2_min5h->ProjectionX("h1_min5i");
      //project out-of-plane
      TH1D* h1_min5o = (TH1D*)h2_min5l->ProjectionX("h1_min5o");
      TH1D* h1_min5 = (TH1D*)h1_min5o->Clone("h1_min5");
      h1_min5->Divide(h1_min5i);
      TH1D* hKinNum_min5 = (TH1D*)fmin5h->Get(histnameKinNum.c_str());
      hKinNum_min5->SetName("hKinNum_min5");
      TH1D* hKinDenom_min5 = (TH1D*)fmin5h->Get(histnameKinDenom.c_str());
      ...
      TFile* frwh = new TFile(hi_reweight.c_str());
      TFile* frwl = new TFile(lo_reweight.c_str());
      TH2D* h2_rwh = (TH2D*)frwh->Get(histname.c_str());
      TH2D* h2_rwl = (TH2D*)frwl->Get(histname.c_str());
      TH1D* h1_rwi = (TH1D*)h2_rwh->ProjectionX("h1_rwi");
      TH1D* h1_rwo = (TH1D*)h2_rwl->ProjectionX("h1_rwo");
      TH1D* h1_rw = (TH1D*)h1_rwo->Clone("h1_rw");
      h1_rw->Divide(h1_rwi);
      TH1D* hKinNum_rw = (TH1D*)frwh->Get(histnameKinNum.c_str());
      hKinNum_rw->SetName("hKinNum_rw");
      TH1D* hKinDenom_rw = (TH1D*)frwh->Get(histnameKinDenom.c_str());
  ...
  //================================================================
      ...
      name << "preSystematics_R020_3050_ratio_Feb4.root";
