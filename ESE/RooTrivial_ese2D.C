...
void RooTrivial_ese2D(double centl, double centr, int ese, int R = 2, int epcut = 2, TString cFiles2="files15.txt")
{
#ifdef __CINT__
  ...
  //==================================================================================
    ...
    stringstream ww;
    if (ese == 0)  ww << "UnfoldingTrivial_2D_non_R02_" << Form("%.0f", centl) << Form("%.0f", centr) << "_lo30_Feb1.root"; 
    if (ese == 1)  ww << "UnfoldingTrivial_2D_non_R02_" << Form("%.0f", centl) << Form("%.0f", centr) << "_hi30_Feb1.root"; 
    if (ese == 2)  ww << "UnfoldingTrivial_2D_non_R02_" << Form("%.0f", centl) << Form("%.0f", centr) << "_30q_Feb1.root"; 
