...
// Unfolding
//==============================================================================
//if R = 0.2, use files28.txt
//if R = 0.4, use files26.txt
void RooTrak_ese2D(double centl, double centr, int ese, int R = 2, int epcut = 2, TString cFiles2="files28.txt")
{
#ifdef __CINT__
  ...
  //std::vector<double> kBinsMeasured = {truncation, 35.0, 40.0, 50.0, 65.0, 80.0, 100.0, 120.0, 140.0};   //R = 0.4
      ...
      for (int j = 0; j < centdiff; j++) {
        ...
        for (int i = 0; i <= q2hist->GetNbinsX(); i++)   {
          ...
          if (percentileticker >= percentilen*percentilemarker)  {
              //cout << "	percentileticker: " << percentileticker << " > " << percentilen*percentilemarker <<"\n";
              //cout << "	i: " << i <<"\n";
  ...
  //==================================================================================
    ...
    stringstream ww;
    if (ese == 0)  ww << "UnfoldingData_2D_non_R0" << R << "_qV0C_epV0A_" 
                      << Form("%.0f", centl) << Form("%.0f", centr) << "_lo30_trak_" << Form("%.0f", truncation) << "_Dec1.root"; 
    if (ese == 1)  ww << "UnfoldingData_2D_non_R0" << R << "_qV0C_epV0A_" 
                      << Form("%.0f", centl) << Form("%.0f", centr) << "_hi30_trak_" << Form("%.0f", truncation) << "_Dec1.root"; 
    if (ese == 2)  ww << "UnfoldingData_2D_non_R0" << R << "_qV0C_epV0A_" 
                      << Form("%.0f", centl) << Form("%.0f", centr) << "_allq_trak_" << Form("%.0f", truncation) << "_Dec1.root"; 
    if (ese == 3)  ww << "UnfoldingData_2D_non_R0" << R << "_qV0C_epV0A_" 
                      << Form("%.0f", centl) << Form("%.0f", centr) << "_1040_trak_" << Form("%.0f", truncation) << "_Dec1.root"; 
