...
void RooTrak_ese2D(double centl, double centr, int ese, int R = 2, int epcut = 2, TString cFiles2="files16.txt")
{
#ifdef __CINT__
  ...
  //==================================================================================
    ...
    stringstream ww;
    if (ese == 0)  ww << "UnfoldingData_2D_non_R02_" << Form("%.0f", centl) << Form("%.0f", centr) << "_lo30_trak_Feb4.root"; 
    if (ese == 1)  ww << "UnfoldingData_2D_non_R02_" << Form("%.0f", centl) << Form("%.0f", centr) << "_hi30_trak_Feb4.root"; 
    if (ese == 2)  ww << "UnfoldingData_2D_non_R02_" << Form("%.0f", centl) << Form("%.0f", centr) << "_allq_trak_Feb4.root"; 
